...
public sealed class EndpointAuthorizationTests
{
    ...
    [TestMethod]
    public void Api_v1_endpoints_do_not_bind_retired_identity_roles_write()
    {
        using var app = BuildApiApplication();
        ...
        {
            Assert.Fail(
                "identity.roles.write 已退役，下列 Endpoint 仍绑定该权限: "
                + string.Join(", ", violations));
        }
    }

    [TestMethod]
    public void Api_v1_endpoints_do_not_bind_retired_identity_role_field_grants_write()
    {
        using var app = BuildApiApplication();
        ...
        {
            Assert.Fail(
                "identity.role_field_grants.write 已退役，下列 Endpoint 仍绑定该权限: "
                + string.Join(", ", violations));
        }
    }

    [TestMethod]
    public void Api_v1_endpoints_do_not_bind_retired_identity_menus_write()
    {
        using var app = BuildApiApplication();
        ...
        {
            Assert.Fail(
                "identity.menus.write 已退役，下列 Endpoint 仍绑定该权限: "
                + string.Join(", ", violations));
        }
    }

    [TestMethod]
    public void Api_v1_endpoints_do_not_bind_retired_identity_sessions_write()
    {
        using var app = BuildApiApplication();
        ...
        {
            Assert.Fail(
                "identity.sessions.write 已退役，下列 Endpoint 仍绑定该权限: "
                + string.Join(", ", violations));
        }
    }

    [TestMethod]
    public void Api_v1_endpoints_do_not_bind_retired_identity_api_keys_write()
    {
        using var app = BuildApiApplication();
    ...
    [TestMethod]
    public void Api_v1_endpoints_do_not_bind_retired_tenancy_tenant_packages_write()
    {
        using var app = BuildApiApplication();
    ...
    [TestMethod]
    public void Api_v1_endpoints_do_not_bind_retired_organization_positions_write()
    {
        using var app = BuildApiApplication();
        ...
        {
            Assert.Fail(
                "organization.positions.write 已退役，下列 Endpoint 仍绑定该权限: "
                + string.Join(", ", violations));
        }
    }

    [TestMethod]
    public void Api_v1_endpoints_do_not_bind_retired_organization_position_levels_write()
    {
        using var app = BuildApiApplication();
        ...
        {
            Assert.Fail(
                "organization.position_levels.write 已退役，下列 Endpoint 仍绑定该权限: "
                + string.Join(", ", violations));
        }
    }

    [TestMethod]
    public void Api_v1_endpoints_do_not_bind_retired_organization_user_positions_write()
    {
        using var app = BuildApiApplication();
        ...
        {
            Assert.Fail(
                "organization.user_positions.write 已退役，下列 Endpoint 仍绑定该权限: "
                + string.Join(", ", violations));
        }
    }
    ...
    public void Api_v1_endpoints_do_not_bind_retired_settings_tenant_dict_types_write()
    {
        ...
        {
            Assert.Fail(
                "settings.tenant_dict_types.write 已退役，下列 Endpoint 仍绑定该权限: "
                + string.Join(", ", violations));
        }
    }

    [TestMethod]
    public void Api_v1_endpoints_do_not_bind_retired_settings_diagnostic_policy_write()
    {
        using var app = BuildApiApplication();
        ...
        {
            Assert.Fail(
                "settings.diagnostic_policy.write 已退役，下列 Endpoint 仍绑定该权限: "
                + string.Join(", ", violations));
        }
    }
