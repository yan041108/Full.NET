...
public sealed class IdentityApiMySqlTests
{
    ...
    [TestMethod]
    public async Task Oidc_center_logout_invalidates_protocol_grants_with_mysql()
    {
    ...
    [TestMethod]
    public async Task Oidc_context_switch_preserves_other_application_session_with_mysql()
    {
    ...
    [TestMethod]
    public async Task Oidc_context_switch_races_are_linearized_with_mysql()
    {
    ...
    [TestMethod]
    public async Task Oidc_context_switch_revoke_races_remain_authoritative_with_mysql()
    {
    ...
    [TestMethod]
    public async Task Oidc_context_switch_invalidates_background_session_binding_with_mysql()
    {
    ...
    [TestMethod]
    public async Task Oidc_context_switch_preserves_agent_tools_consumer_path_with_mysql()
    {
    ...
    [TestMethod]
    public async Task Oidc_context_switch_preserves_legacy_session_independence_with_mysql()
    {
    ...
    [TestMethod]
    public async Task Oidc_context_switch_preserves_approval_consumer_path_with_mysql()
    {
    ...
    [TestMethod]
    public async Task Oidc_context_switch_tokens_validate_on_peer_instance_with_mysql()
    {
    ...
    [TestMethod]
    public async Task Invited_registration_follows_contract_with_mysql()
    {
        using var factory = new FullNetApiFactory(
            DatabaseProvider.MySql,
            await SharedDatabaseFixture.CreateMySqlDatabaseAsync());
