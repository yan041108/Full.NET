...
/// <summary>
/// 校验 Host 角色管理端点在 OpenAPI 文档中的路径、方法与核心 schema 属性。
/// </summary>
internal static class OpenApiHostRolesContractAssertions
{
        ...
        out JsonElement schema)
    {
        ...
        if (schemaName == "HostRoleResponsePage")
        {
            ...
            {
                if (!candidate.Name.Contains("HostRoleResponse", StringComparison.Ordinal))
                {
                    continue;
                }
