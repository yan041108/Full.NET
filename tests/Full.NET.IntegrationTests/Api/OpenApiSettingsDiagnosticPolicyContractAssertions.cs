...
/// <summary>
/// 校验 Host 限时诊断策略端点在 OpenAPI 文档中的路径、方法与核心 schema 属性。
/// </summary>
internal static class OpenApiSettingsDiagnosticPolicyContractAssertions
{
    ...
    {
        const string tag = "SettingsHostDiagnosticPolicy";
        ...
        CancellationToken cancellationToken)
    {
        ...
        var contractPath = Path.Combine(
            ...
            "contracts",
            "openapi",
            "settings-diagnostic-policy-v1.json");
