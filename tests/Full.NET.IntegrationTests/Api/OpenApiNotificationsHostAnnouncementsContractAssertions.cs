...
/// <summary>
/// 校验 Host 公告端点在 OpenAPI 文档中的路径、方法与核心 schema 属性。
/// </summary>
internal static class OpenApiNotificationsHostAnnouncementsContractAssertions
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var contractPath = Path.Combine(
            ...
            "contracts",
            "openapi",
            "notifications-host-announcements-v1.json");
