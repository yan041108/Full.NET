...
/// <summary>
/// 校验 OpenAccess 接入方应用端点在 OpenAPI 文档中的路径与核心 schema。
/// </summary>
internal static class OpenApiIdentityOpenAccessClientsContractAssertions
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var contractPath = Path.Combine(
            ...
            "contracts",
            "openapi",
            "identity-open-access-clients-v1.json");
