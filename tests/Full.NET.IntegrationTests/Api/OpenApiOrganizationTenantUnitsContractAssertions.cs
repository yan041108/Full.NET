...
/// <summary>
/// 校验租户机构管理端点在 OpenAPI 文档中的路径、方法与核心 schema 属性。
/// </summary>
internal static class OpenApiOrganizationTenantUnitsContractAssertions
{
        ...
        out JsonElement schema)
    {
        ...
        if (schemaName == "OrganizationUnitResponsePage")
        {
            ...
            {
                if (!candidate.Name.Contains("OrganizationUnitResponse", StringComparison.Ordinal))
                {
                    continue;
                }
        ...
        CancellationToken cancellationToken)
    {
        ...
        var contractPath = Path.Combine(
            ...
            "contracts",
            "openapi",
            "organization-tenant-units-v1.json");
