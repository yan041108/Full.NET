...
/// <summary>
/// 校验 Host 租户管理端点在 OpenAPI 文档中的路径、方法与核心 schema 属性。
/// </summary>
internal static class OpenApiHostTenantsContractAssertions
{
        ...
        out JsonElement schema)
    {
        ...
        if (schemaName == "TenantSummaryPage")
        {
            ...
            {
                if (!candidate.Name.Contains("TenantSummary", StringComparison.Ordinal))
                {
                    continue;
                }
