...
/// <summary>
/// 校验 Host 菜单管理端点在 OpenAPI 文档中的路径、方法与核心 schema 属性。
/// </summary>
internal static class OpenApiHostMenusContractAssertions
{
        ...
        out JsonElement schema)
    {
        ...
        if (schemaName == "HostMenuResponsePage")
        {
            ...
            {
                if (!candidate.Name.Contains("HostMenuResponse", StringComparison.Ordinal))
                {
                    continue;
                }
