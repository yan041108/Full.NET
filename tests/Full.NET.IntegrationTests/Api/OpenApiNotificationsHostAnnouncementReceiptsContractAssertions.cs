...
/// <summary>
/// 校验 Host 公告收件与阅读统计端点在 OpenAPI 文档中的路径、方法与核心 schema 属性。
/// </summary>
internal static class OpenApiNotificationsHostAnnouncementReceiptsContractAssertions
{
    ...
    private static void AssertPilotOperations(JsonElement document)
    {
        ...
        OpenApiPilotContractAssertions.AssertOperation(
            ...
            HttpMethod.Get,
            "notificationsGetMyHostAnnouncementUnreadCount",
            myTag,
            200,
            "application/json");
        OpenApiPilotContractAssertions.AssertOperation(
            ...
            HttpMethod.Get,
            "notificationsGetMyHostAnnouncement",
            myTag,
            200,
            "application/json");
        OpenApiPilotContractAssertions.AssertOperation(
            ...
            HttpMethod.Post,
            "notificationsMarkMyHostAnnouncementRead",
            myTag,
            200,
            "application/json");
        OpenApiPilotContractAssertions.AssertOperation(
            ...
            HttpMethod.Post,
            "notificationsMarkAllMyHostAnnouncementsRead",
            myTag,
            200,
            "application/json");

        const string hostTag = "NotificationsHostAnnouncements";
        OpenApiPilotContractAssertions.AssertOperation(
            document,
            "/api/v1/notifications/host-announcements/{announcementId}/read-stats",
            HttpMethod.Get,
            "notificationsGetHostAnnouncementReadStats",
            hostTag,
            200,
            "application/json");
        OpenApiPilotContractAssertions.AssertOperation(
            ...
            HttpMethod.Get,
            "notificationsListHostAnnouncementReadReceipts",
            hostTag,
            200,
            "application/json");
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        var contractPath = Path.Combine(
            ...
            "contracts",
            "openapi",
            "notifications-host-announcement-receipts-v1.json");
