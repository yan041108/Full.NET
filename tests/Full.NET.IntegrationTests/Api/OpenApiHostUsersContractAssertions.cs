...
/// <summary>
/// 校验 Host 用户管理端点在 OpenAPI 文档中的路径、方法与核心 schema 属性。
/// </summary>
internal static class OpenApiHostUsersContractAssertions
{
        ...
        out JsonElement schema)
    {
        ...
        if (schemaName == "HostUserResponsePage")
        {
            ...
            {
                if (!candidate.Name.Contains("HostUserResponse", StringComparison.Ordinal))
                {
                    continue;
                }
