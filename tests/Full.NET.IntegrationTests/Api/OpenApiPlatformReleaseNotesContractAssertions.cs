...
/// <summary>
/// 校验平台更新日志端点在 OpenAPI 文档中的路径、方法与核心 schema 属性。
/// </summary>
internal static class OpenApiPlatformReleaseNotesContractAssertions
{
    ...
    {
        const string hostTag = "PlatformHostReleaseNotes";
        const string myTag = "PlatformMyReleaseNotes";
        OpenApiPilotContractAssertions.AssertOperation(
            document,
            "/api/v1/platform/host-release-notes",
            HttpMethod.Get,
            "platformListHostReleaseNotes",
            hostTag,
            200,
            "application/json");
        OpenApiPilotContractAssertions.AssertOperation(
            document,
            "/api/v1/platform/host-release-notes/{releaseNoteId}",
            HttpMethod.Get,
            "platformGetHostReleaseNote",
            hostTag,
            200,
            "application/json");
        OpenApiPilotContractAssertions.AssertOperation(
        ...
        OpenApiPilotContractAssertions.AssertOperation(
            ...
            "/api/v1/platform/host-release-notes/{releaseNoteId}",
            HttpMethod.Put,
            "platformUpdateHostReleaseNote",
            hostTag,
            200,
            "application/json");
        OpenApiPilotContractAssertions.AssertOperation(
            document,
            "/api/v1/platform/host-release-notes/{releaseNoteId}/publish",
            HttpMethod.Post,
            "platformPublishHostReleaseNote",
            hostTag,
            200,
            "application/json");
        OpenApiPilotContractAssertions.AssertOperation(
            document,
            "/api/v1/platform/host-release-notes/{releaseNoteId}/retract",
            HttpMethod.Post,
            "platformRetractHostReleaseNote",
            hostTag,
            200,
            "application/json");
        OpenApiPilotContractAssertions.AssertOperation(
            document,
            "/api/v1/platform/host-release-notes/{releaseNoteId}/delete",
            HttpMethod.Post,
            "platformDeleteHostReleaseNote",
            hostTag,
            204,
            null);
        OpenApiPilotContractAssertions.AssertOperation(
            document,
            "/api/v1/platform/my-release-notes",
            HttpMethod.Get,
            "platformListMyReleaseNotes",
            myTag,
            200,
            "application/json");
        OpenApiPilotContractAssertions.AssertOperation(
            ...
            HttpMethod.Get,
            "platformGetLatestUnreadReleaseNote",
            myTag,
            200,
            "application/json");
        OpenApiPilotContractAssertions.AssertOperation(
            document,
            "/api/v1/platform/my-release-notes/{releaseNoteId}/read",
            HttpMethod.Post,
            "platformMarkMyReleaseNoteRead",
            myTag,
            200,
            "application/json");
    }
        ...
        JsonElement contractSchema)
    {
        ...
        {
            "HostReleaseNoteResponsePage" => "PagedResultOfHostReleaseNoteResponse",
            "MyReleaseNoteResponsePage" => "PagedResultOfMyReleaseNoteResponse",
            _ => schemaName
        };
        ...
        CancellationToken cancellationToken)
    {
        ...
        var contractPath = Path.Combine(
            ...
            "contracts",
            "openapi",
            "platform-release-notes-v1.json");
