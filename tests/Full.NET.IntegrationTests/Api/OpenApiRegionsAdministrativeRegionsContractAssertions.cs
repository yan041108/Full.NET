...
/// <summary>
/// 校验行政区域端点在 OpenAPI 文档中的路径、方法与核心 schema 属性。
/// </summary>
internal static class OpenApiRegionsAdministrativeRegionsContractAssertions
{
    ...
    {
        const string tag = "RegionsAdministrativeRegions";
        OpenApiPilotContractAssertions.AssertOperation(
            document,
            "/api/v1/regions/administrative-regions/children",
            HttpMethod.Get,
            "regionsListAdministrativeRegionChildren",
            tag,
            200,
            "application/json");
        OpenApiPilotContractAssertions.AssertOperation(
            document,
            "/api/v1/regions/administrative-regions/tree",
            HttpMethod.Get,
            "regionsGetAdministrativeRegionTree",
            tag,
            200,
            "application/json");
        OpenApiPilotContractAssertions.AssertOperation(
            ...
            HttpMethod.Get,
            "regionsListAdministrativeRegions",
            tag,
            200,
            "application/json");
        OpenApiPilotContractAssertions.AssertOperation(
            ...
            "/api/v1/regions/administrative-regions",
            HttpMethod.Post,
            "regionsCreateAdministrativeRegion",
            tag,
            201,
            "application/json");
        OpenApiPilotContractAssertions.AssertOperation(
            document,
            "/api/v1/regions/administrative-regions/dataset-manifest/latest",
            HttpMethod.Get,
            "regionsGetLatestAdministrativeRegionDatasetManifest",
            tag,
            200,
            "application/json");
        OpenApiPilotContractAssertions.AssertOperation(
            document,
            "/api/v1/regions/administrative-regions/{regionId}",
            HttpMethod.Get,
            "regionsGetAdministrativeRegion",
            tag,
            200,
            "application/json");
        OpenApiPilotContractAssertions.AssertOperation(
            ...
            "/api/v1/regions/administrative-regions/{regionId}",
            HttpMethod.Put,
            "regionsUpdateAdministrativeRegion",
            tag,
            200,
            "application/json");
        OpenApiPilotContractAssertions.AssertOperation(
            document,
            "/api/v1/regions/administrative-regions/{regionId}/delete",
            HttpMethod.Post,
            "regionsDeleteAdministrativeRegion",
            tag,
            204,
            null);
        OpenApiPilotContractAssertions.AssertOperation(
            ...
            HttpMethod.Post,
            "regionsPreviewAdministrativeRegionImport",
            tag,
            200,
            "application/json");
        OpenApiPilotContractAssertions.AssertOperation(
            ...
            HttpMethod.Post,
            "regionsApplyAdministrativeRegionImport",
            tag,
            200,
            "application/json");
    }
        ...
        JsonElement contractSchema)
    {
        ...
        {
            "AdministrativeRegionResponsePage" => "PagedResultOfAdministrativeRegionResponse",
            _ => schemaName,
        };

        if (!TryFindSchema(openApiSchemas, resolvedSchemaName, out var openApiSchema))
        {
            if (schemaName is "AdministrativeRegionChildResponseList"
                or "AdministrativeRegionTreeNodeResponseList")
            {
                return;
            }
        ...
        if (!contractSchema.TryGetProperty("properties", out var contractProperties))
        {
            return;
        }

        var openApiProperties = openApiSchema.GetProperty("properties");
        foreach (var property in contractProperties.EnumerateArray())
        {
        ...
        CancellationToken cancellationToken)
    {
        ...
        var contractPath = Path.Combine(
            ...
            "contracts",
            "openapi",
            "regions-administrative-regions-v1.json");
