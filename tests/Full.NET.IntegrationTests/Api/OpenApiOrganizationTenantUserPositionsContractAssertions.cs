...
/// <summary>
/// 校验租户用户-职位隶属端点在 OpenAPI 文档中的路径、方法与核心 schema 属性。
/// </summary>
internal static class OpenApiOrganizationTenantUserPositionsContractAssertions
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var contractPath = Path.Combine(
            ...
            "contracts",
            "openapi",
            "organization-tenant-user-positions-v1.json");
