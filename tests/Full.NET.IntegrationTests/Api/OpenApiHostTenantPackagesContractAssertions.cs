...
/// <summary>
/// 校验 Host 租户套餐目录端点在 OpenAPI 文档中的路径、方法与核心 schema 属性。
/// </summary>
internal static class OpenApiHostTenantPackagesContractAssertions
{
        ...
        out JsonElement schema)
    {
        ...
        if (schemaName == "TenantPackageSummaryPage")
        {
            ...
            {
                if (!candidate.Name.Contains("TenantPackageSummary", StringComparison.Ordinal))
                {
                    continue;
                }
        ...
        CancellationToken cancellationToken)
    {
        ...
        var contractPath = Path.Combine(
            ...
            "contracts",
            "openapi",
            "tenancy-host-tenant-packages-v1.json");
