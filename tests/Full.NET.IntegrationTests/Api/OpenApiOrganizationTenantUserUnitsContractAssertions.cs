...
/// <summary>
/// 校验租户用户-机构隶属端点在 OpenAPI 文档中的路径、方法与核心 schema 属性。
/// </summary>
internal static class OpenApiOrganizationTenantUserUnitsContractAssertions
{
        ...
        out JsonElement schema)
    {
        ...
        if (schemaName == "OrganizationUserUnitResponsePage")
        {
            ...
            {
                if (!candidate.Name.Contains("OrganizationUserUnitResponse", StringComparison.Ordinal))
                {
                    continue;
                }
        ...
        CancellationToken cancellationToken)
    {
        ...
        var contractPath = Path.Combine(
            ...
            "contracts",
            "openapi",
            "organization-tenant-user-units-v1.json");
