...
/// <summary>
/// 验证 074 将存量 jobs.definitions.write 展开为四个精确 Host 任务定义动作权限，并安全处理角色重复授权与 API Key JSON 去重。
/// </summary>
[TestClass]
public sealed class Migration074JobsDefinitionActionPermissionsRecoveryTests
{
    private const string LegacyWrite = "jobs.definitions.write";
    private const string ActionCreate = "jobs.definitions.create";
        ...
        connection.ExecuteAsync(
            isSqlServer
                ? """
                  ...
                  WHERE ScriptName LIKE '%074_JobsDefinitionActionPermissions.sql';
                  """
                : """
