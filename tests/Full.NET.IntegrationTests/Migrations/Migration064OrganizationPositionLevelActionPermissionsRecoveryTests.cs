...
/// <summary>
/// 验证 064 将存量 organization.position_levels.write 展开为三个精确租户职级动作权限，并安全处理角色重复授权与 API Key JSON 去重。
/// </summary>
[TestClass]
public sealed class Migration064OrganizationPositionLevelActionPermissionsRecoveryTests
{
    private const string LegacyWrite = "organization.position_levels.write";
    private const string ActionCreate = "organization.position_levels.create";
        ...
        connection.ExecuteAsync(
            isSqlServer
                ? """
                  ...
                  WHERE ScriptName LIKE '%064_OrganizationPositionLevelActionPermissions.sql';
                  """
                : """
