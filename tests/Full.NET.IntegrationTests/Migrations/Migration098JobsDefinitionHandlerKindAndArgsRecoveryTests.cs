...
[TestClass]
public sealed class Migration098JobsDefinitionHandlerKindAndArgsRecoveryTests
{
    [TestMethod]
    public Task MySql_applies_handler_kind_and_args_idempotently() =>
        VerifyAsync(DatabaseProvider.MySql);

    [TestMethod]
    public Task SqlServer_applies_handler_kind_and_args_idempotently() =>
