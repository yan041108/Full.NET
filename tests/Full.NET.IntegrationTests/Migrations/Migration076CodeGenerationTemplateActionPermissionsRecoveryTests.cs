...
/// <summary>
/// 验证 076 将存量 codegen.templates.write 展开为三个精确 Host 代码生成模板动作权限，并安全处理角色重复授权与 API Key JSON 去重。
/// </summary>
[TestClass]
public sealed class Migration076CodeGenerationTemplateActionPermissionsRecoveryTests
{
    private const string LegacyWrite = "codegen.templates.write";
    private const string ActionCreate = "codegen.templates.create";
        ...
        connection.ExecuteAsync(
            isSqlServer
                ? """
                  ...
                  WHERE ScriptName LIKE '%076_CodeGenerationTemplateActionPermissions.sql';
                  """
                : """
