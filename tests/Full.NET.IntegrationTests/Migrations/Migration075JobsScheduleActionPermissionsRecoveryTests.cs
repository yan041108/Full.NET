...
/// <summary>
/// 验证 075 将存量 jobs.schedules.write 展开为四个精确 Host 任务计划动作权限，并安全处理角色重复授权与 API Key JSON 去重。
/// </summary>
[TestClass]
public sealed class Migration075JobsScheduleActionPermissionsRecoveryTests
{
    private const string LegacyWrite = "jobs.schedules.write";
    private const string ActionCreate = "jobs.schedules.create";
        ...
        connection.ExecuteAsync(
            isSqlServer
                ? """
                  ...
                  WHERE ScriptName LIKE '%075_JobsScheduleActionPermissions.sql';
                  """
                : """
