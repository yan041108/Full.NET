...
/// <summary>确认 090 的 THEN/ALTER 粘连修复后可幂等应用。</summary>
[TestClass]
public sealed class Migration090SettingsConfigEntryGroupNameRecoveryTests
{
    [TestMethod]
    public Task MySql_applies_settings_config_entry_group_name_idempotently() =>
        VerifyAsync(DatabaseProvider.MySql);

    [TestMethod]
    public Task SqlServer_applies_settings_config_entry_group_name_idempotently() =>
