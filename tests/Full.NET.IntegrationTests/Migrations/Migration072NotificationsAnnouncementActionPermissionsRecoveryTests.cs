...
/// <summary>
/// 验证 072 将存量 notifications.announcements.write 展开为三个精确 Host 公告动作权限，并安全处理角色重复授权与 API Key JSON 去重。
/// </summary>
[TestClass]
public sealed class Migration072NotificationsAnnouncementActionPermissionsRecoveryTests
{
    private const string LegacyWrite = "notifications.announcements.write";
    private const string ActionCreate = "notifications.announcements.create";
        ...
        connection.ExecuteAsync(
            isSqlServer
                ? """
                  ...
                  WHERE ScriptName LIKE '%072_NotificationsAnnouncementActionPermissions.sql';
                  """
                : """
