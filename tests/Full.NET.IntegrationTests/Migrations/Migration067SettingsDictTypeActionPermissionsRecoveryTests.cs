...
/// <summary>
/// 验证 067 将存量 settings.dict_types.write 展开为三个精确 Host 数据字典动作权限，并安全处理角色重复授权与 API Key JSON 去重。
/// </summary>
[TestClass]
public sealed class Migration067SettingsDictTypeActionPermissionsRecoveryTests
{
    private const string LegacyWrite = "settings.dict_types.write";
    private const string ActionCreate = "settings.dict_types.create";
        ...
        connection.ExecuteAsync(
            isSqlServer
                ? """
                  ...
                  WHERE ScriptName LIKE '%067_SettingsDictTypeActionPermissions.sql';
                  """
                : """
