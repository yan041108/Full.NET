...
[TestClass]
public sealed class Migration097JobsWorkerHeartbeatRecoveryTests
{
    [TestMethod]
    public Task MySql_applies_worker_heartbeat_idempotently() =>
        VerifyAsync(DatabaseProvider.MySql);

    [TestMethod]
    public Task SqlServer_applies_worker_heartbeat_idempotently() =>
