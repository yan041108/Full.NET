...
/// <summary>
/// 验证 063 将存量 organization.positions.write 展开为五个精确租户职位动作权限，并安全处理角色重复授权与 API Key JSON 去重。
/// </summary>
[TestClass]
public sealed class Migration063OrganizationPositionActionPermissionsRecoveryTests
{
    private const string LegacyWrite = "organization.positions.write";
    private const string ActionCreate = "organization.positions.create";
        ...
        connection.ExecuteAsync(
            isSqlServer
                ? """
                  ...
                  WHERE ScriptName LIKE '%063_OrganizationPositionActionPermissions.sql';
                  """
                : """
