...
/// <summary>
/// 验证 065 将存量 organization.user_positions.write 展开为三个精确租户用户职位隶属动作权限，并安全处理角色重复授权与 API Key JSON 去重。
/// </summary>
[TestClass]
public sealed class Migration065OrganizationUserPositionActionPermissionsRecoveryTests
{
    private const string LegacyWrite = "organization.user_positions.write";
    private const string ActionCreate = "organization.user_positions.create";
        ...
        connection.ExecuteAsync(
            isSqlServer
                ? """
                  ...
                  WHERE ScriptName LIKE '%065_OrganizationUserPositionActionPermissions.sql';
                  """
                : """
