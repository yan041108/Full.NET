...
/// <summary>确认 088 从 UTF-16 纠正为 UTF-8 后可幂等应用。</summary>
[TestClass]
public sealed class Migration088IdentityNavigationMenuMetaRecoveryTests
{
    [TestMethod]
    public Task MySql_applies_identity_navigation_menu_meta_idempotently() =>
        VerifyAsync(DatabaseProvider.MySql);

    [TestMethod]
    public Task SqlServer_applies_identity_navigation_menu_meta_idempotently() =>
