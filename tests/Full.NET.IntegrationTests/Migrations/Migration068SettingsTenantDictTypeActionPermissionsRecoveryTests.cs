...
/// <summary>
/// 验证 068 将存量 settings.tenant_dict_types.write 展开为三个精确 租户数据字典动作权限，并安全处理角色重复授权与 API Key JSON 去重。
/// </summary>
[TestClass]
public sealed class Migration068SettingsTenantDictTypeActionPermissionsRecoveryTests
{
    private const string LegacyWrite = "settings.tenant_dict_types.write";
    private const string ActionCreate = "settings.tenant_dict_types.create";
        ...
        connection.ExecuteAsync(
            isSqlServer
                ? """
                  ...
                  WHERE ScriptName LIKE '%068_SettingsTenantDictTypeActionPermissions.sql';
                  """
                : """
