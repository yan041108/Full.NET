...
/// <summary>确认 087 从 UTF-16 纠正为 UTF-8 后可幂等应用。</summary>
[TestClass]
public sealed class Migration087IdentityUserAccountTypeRecoveryTests
{
    [TestMethod]
    public Task MySql_applies_identity_user_account_type_idempotently() =>
        VerifyAsync(DatabaseProvider.MySql);

    [TestMethod]
    public Task SqlServer_applies_identity_user_account_type_idempotently() =>
