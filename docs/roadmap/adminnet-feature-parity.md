...
| **B1** | 高 | CodeGeneration | **Build-verified**（可视化工作台、Vue SFC、Host Apply 接线、鉴权下载、Tree/关系；[验证](../verification/codegeneration-adminnet-parity-2026-08-16.md)） |
