...
| 菜单、页面与按钮权限管理 | Identity | Core | M2 | **Build-verified**（Identity Users 完整样板：授权树 API、角色页面/操作树、Vue `PermissionGate` 逐按钮门控、双库动作边界 Integration、迁移 054、Vue 真实栈按钮缺失与 API 403；见[设计](../superpowers/specs/2026-08-02-vue-action-authorization-design.md)、[计划](../superpowers/plans/2026-08-02-vue-action-authorization.md)、[验证](../verification/vue-action-authorization-2026-08-02.md)；全模块清零见 Task 10 清单） |
