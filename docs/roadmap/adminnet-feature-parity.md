...
| 邮件与短信 | Notifications Providers | Provider | M5+ | Mapped（统一 Profile/Binding/Delivery 平台已 **Build-verified**，见[收口验证](../verification/2026-08-31-notifications-platform-closeout.md)；邮件/短信渠道本身未实现。首个真实 Provider 尚未选择，需厂商独立纵向计划） |
...
| 消息中心 | Notifications | Core | M3 | **Build-verified**（现有 Host 发信 + 个人收件箱/未读/已读）；平台内核（政策/路由/状态机、权限码、104 十四张平台表）为 **Build-verified**，见[内核验证](../verification/2026-08-31-notifications-platform-kernel.md)；Tenant Inbox 与权威未读数为 **Build-verified**，见[Tenant Inbox 验证](../verification/2026-08-31-notifications-tenant-inbox.md)；模板/Intent API（仅 inbox）为 **Build-verified**，见[Template/Intent 验证](../verification/2026-08-31-notifications-template-intent.md)；多 Profile/Binding 控制面为 **Build-verified**，见[Profile/Binding 验证](../verification/2026-08-31-notifications-profile-binding.md)；Delivery Worker（租约/Attempt/Receipt/人工重试，Test Provider）为 **Build-verified**，见[Delivery Worker 验证](../verification/2026-08-31-notifications-delivery-worker.md)；Vue 管理控制面为 **Build-verified**，见[Vue 控制面验证](../verification/2026-08-31-notifications-vue-control-plane.md)；平台扩展切片已按[收口验证](../verification/2026-08-31-notifications-platform-closeout.md)关闭，新扩展最多 **Build-verified**，不得升 `Verified`；真实外部 Provider 仍为 **Planned**，见[批准 Spec](../superpowers/specs/2026-08-30-notifications-platform-extension-design.md)与[实施计划](../superpowers/plans/2026-08-30-notifications-platform-extension.md)；不复制 `object Extras`） |
