...
| SignalR / Realtime | `Build-verified` | `IRealtimePublisher`、鉴权 Hub、用户/租户分组、MessagePack 与可选 Redis Backplane 已实现；双库 Integration **2/2**；见[验证记录](../verification/realtime-signalr-foundation-2026-07-26.md) | 管理端实时客户端、多实例 Backplane 真实栈与 Outbox 驱动推送尚未完成 |
