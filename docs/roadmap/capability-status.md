...
| 最小 RBAC 与权限导航 | `Build-verified` | **Host 用户**、**Host 角色**与 **Host 菜单** API + 双端 UI + 双库集成 + Mock/真实栈冒烟 + OpenAPI 夹具（见[用户验证](../verification/identity-user-management-2026-07-21.md)、[角色验证](../verification/identity-role-management-2026-07-21.md)、[菜单验证](../verification/identity-menu-management-2026-07-21.md)） | 组织/数据范围 CRUD；用户-角色分配 UI |
...
1. **P0：交付证明——Identity 组织/数据范围**——菜单切片已关闭；禁止与用户/角色/菜单并行三刀。
