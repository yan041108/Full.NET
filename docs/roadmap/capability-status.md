...
| Jobs Host 任务定义 | `Build-verified` | Host 任务定义、手动触发、执行记录与 Worker；过期 `Running` 租约可由 SQL Server/MySQL 原子重新领取；双库 Integration **2/2**；见[验证记录](../verification/jobs-host-definitions-2026-07-26.md) | Cron/延迟调度、失败分类、运维重放和多 Worker 压力验证仍待补 |
