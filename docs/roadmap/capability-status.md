...
| UUID v7 主键与跨库物理存�?| `Build-verified` | `UuidStorageContractV1`�?08/009 双库迁移、`PrimaryKeyTypeMapping`、`validate-uuid-storage-sql`�?10+ 门禁）、UUID 集成测试（Expand/Contract/Recovery 31 项）、应用持久化/外部契约测试、Runbook 与[自动化恢复演练记录](../verification/uuid-v7-primary-key-storage-2026-07-19.md)、真实栈 MySQL E2E �?Binary16；当前声明门�?**363/7/43/172** | 真实生产维护窗口与整库备份恢�?RPO/RTO 实跑、SQL Server 聚集索引性能基准尚未完成 |
