...
OpenAPI 驱动客户端生成按 [`ADR-0007`](../architecture/adr/ADR-0007-openapi-driven-client-generation-boundary.md) 和[专项实施计划](../superpowers/plans/2026-08-21-openapi-driven-client-generation.md)执行。三类试点已 `Pilot-passed`；Identity Host Roles、Menus、API Keys、Online Sessions 与 Module Catalog remaining slice 已 `Slice-passed`（现 58 条 `generated`，见[Roles](../verification/openapi-client-identity-host-roles-2026-08-21.md)、[Menus](../verification/openapi-client-identity-host-menus-2026-08-21.md)、[API Keys](../verification/openapi-client-identity-host-api-keys-2026-08-22.md)、[Online Sessions](../verification/openapi-client-identity-host-online-sessions-2026-08-22.md)、[Module Catalog](../verification/openapi-client-identity-host-modules-2026-08-22.md)）。其余 Vue API 模块仍保持手写实现，只能按单模块 slice 迁移，禁止批量重写。
