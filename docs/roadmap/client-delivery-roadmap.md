...
OpenAPI 驱动客户端生成按 [`ADR-0007`](../architecture/adr/ADR-0007-openapi-driven-client-generation-boundary.md) 和[专项实施计划](../superpowers/plans/2026-08-21-openapi-driven-client-generation.md)执行。三类试点已 `Pilot-passed`；Identity remaining（含 `src/api` 队列与独立 [Auth Session](../verification/openapi-client-identity-auth-session-2026-08-22.md)）已全部 `Slice-passed`（现 70 条 `generated`，见[Roles](../verification/openapi-client-identity-host-roles-2026-08-21.md)、[Menus](../verification/openapi-client-identity-host-menus-2026-08-21.md)、[API Keys](../verification/openapi-client-identity-host-api-keys-2026-08-22.md)、[Online Sessions](../verification/openapi-client-identity-host-online-sessions-2026-08-22.md)、[Module Catalog](../verification/openapi-client-identity-host-modules-2026-08-22.md)、[Me](../verification/openapi-client-identity-me-2026-08-22.md)、[TOTP Enrollment](../verification/openapi-client-identity-totp-enrollment-2026-08-22.md)、[Super Administrators](../verification/openapi-client-identity-super-administrators-2026-08-22.md)、[Auth Session](../verification/openapi-client-identity-auth-session-2026-08-22.md)）。下一默认项为其余 Vue API 模块按单模块 slice 迁移，禁止批量重写。
...
8. 继续 [OpenAPI 驱动客户端生成计划](../superpowers/plans/2026-08-21-openapi-driven-client-generation.md) 的单模块迁移：三类试点已 `Pilot-passed`，Identity remaining（`src/api` 队列 + [Auth Session](../superpowers/plans/2026-08-22-openapi-client-identity-auth-session.md)）已全部 `Slice-passed`（现 70 条 `generated`）；下一默认可执行项为其余 Vue API 模块按单模块 slice 迁移，禁止并行批量改写。
