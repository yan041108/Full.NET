...
OpenAPI 驱动客户端生成按 [`ADR-0007`](../architecture/adr/ADR-0007-openapi-driven-client-generation-boundary.md) 和[专项实施计划](../superpowers/plans/2026-08-21-openapi-driven-client-generation.md)执行。三类试点已 `Pilot-passed`；Identity Host Roles、Menus、API Keys、Online Sessions、Module Catalog、Me、TOTP Enrollment 与 Super Administrators remaining slice 已 `Slice-passed`（现 66 条 `generated`，见[Roles](../verification/openapi-client-identity-host-roles-2026-08-21.md)、[Menus](../verification/openapi-client-identity-host-menus-2026-08-21.md)、[API Keys](../verification/openapi-client-identity-host-api-keys-2026-08-22.md)、[Online Sessions](../verification/openapi-client-identity-host-online-sessions-2026-08-22.md)、[Module Catalog](../verification/openapi-client-identity-host-modules-2026-08-22.md)、[Me](../verification/openapi-client-identity-me-2026-08-22.md)、[TOTP Enrollment](../verification/openapi-client-identity-totp-enrollment-2026-08-22.md)、[Super Administrators](../verification/openapi-client-identity-super-administrators-2026-08-22.md)）。Identity remaining `src/api` 队列已完成；下一默认项为独立计划 auth/session。其余 Vue API 模块仍保持手写实现，只能按单模块 slice 迁移，禁止批量重写。
...
8. 继续 [OpenAPI 驱动客户端生成计划](../superpowers/plans/2026-08-21-openapi-driven-client-generation.md) 的单模块迁移：三类试点已 `Pilot-passed`，Identity remaining `src/api` 队列（[Roles](../superpowers/plans/2026-08-21-openapi-client-identity-host-roles.md) / [Menus](../superpowers/plans/2026-08-21-openapi-client-identity-host-menus.md) / [API Keys](../superpowers/plans/2026-08-22-openapi-client-identity-host-api-keys.md) / [Online Sessions](../superpowers/plans/2026-08-22-openapi-client-identity-host-online-sessions.md) / [Module Catalog](../superpowers/plans/2026-08-22-openapi-client-identity-host-modules.md) / [Me](../superpowers/plans/2026-08-22-openapi-client-identity-me.md) / [TOTP Enrollment](../superpowers/plans/2026-08-22-openapi-client-identity-totp-enrollment.md) / [Super Administrators](../superpowers/plans/2026-08-22-openapi-client-identity-super-administrators.md)）已全部 `Slice-passed`；下一默认可执行项为独立计划 auth/session（logout `204`），禁止并行批量改写。
