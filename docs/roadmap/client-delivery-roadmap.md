...
OpenAPI 驱动客户端生成按 [`ADR-0007`](../architecture/adr/ADR-0007-openapi-driven-client-generation-boundary.md) 和[专项实施计划](../superpowers/plans/2026-08-21-openapi-driven-client-generation.md)执行。三类试点已 `Pilot-passed`；Identity Host Roles、Menus、API Keys 与 Online Sessions remaining slice 已 `Slice-passed`（现 56 条 `generated`，见[Roles](../verification/openapi-client-identity-host-roles-2026-08-21.md)、[Menus](../verification/openapi-client-identity-host-menus-2026-08-21.md)、[API Keys](../verification/openapi-client-identity-host-api-keys-2026-08-22.md)、[Online Sessions](../verification/openapi-client-identity-host-online-sessions-2026-08-22.md)）。其余 Vue API 模块仍保持手写实现，只能按单模块 slice 迁移，禁止批量重写。
...
8. 继续 [OpenAPI 驱动客户端生成计划](../superpowers/plans/2026-08-21-openapi-driven-client-generation.md) 的单模块迁移：三类试点已 `Pilot-passed`，[Roles](../superpowers/plans/2026-08-21-openapi-client-identity-host-roles.md) / [Menus](../superpowers/plans/2026-08-21-openapi-client-identity-host-menus.md) / [API Keys](../superpowers/plans/2026-08-22-openapi-client-identity-host-api-keys.md) / [Online Sessions](../superpowers/plans/2026-08-22-openapi-client-identity-host-online-sessions.md) 已 `Slice-passed`；当前进行中为 [Module Catalog](../superpowers/plans/2026-08-22-openapi-client-identity-host-modules.md)，其后按 remaining 队列串行推进，禁止并行批量改写。
