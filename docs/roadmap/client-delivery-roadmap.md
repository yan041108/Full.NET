...
OpenAPI 驱动客户端生成按 [`ADR-0007`](../architecture/adr/ADR-0007-openapi-driven-client-generation-boundary.md) 和[专项实施计划](../superpowers/plans/2026-08-21-openapi-driven-client-generation.md)执行。三类试点已 `Pilot-passed`；Identity Host Roles 与 Host Menus remaining slice 已 `Slice-passed`（现 50 条 `generated`，见[Roles 验证](../verification/openapi-client-identity-host-roles-2026-08-21.md)、[Menus 验证](../verification/openapi-client-identity-host-menus-2026-08-21.md)）。其余 Vue API 模块仍保持手写实现，只能按单模块 slice 迁移，禁止批量重写。
