...
**验收：** Spec 获得明确批准并把能力从 `Mapped` 提升到 `Planned`；否则保持 `Mapped`，不进入实现。**2026-08-02 已产出 Document 规格草案** [`docs/superpowers/specs/2026-08-02-document-module-design.md`](../superpowers/specs/2026-08-02-document-module-design.md) 与实施计划 [`docs/superpowers/plans/2026-08-02-document-host-vertical-slice.md`](../superpowers/plans/2026-08-02-document-host-vertical-slice.md)，待 Gate G4 评审。
