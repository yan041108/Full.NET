...
> **Status (2026-08-16):** Tasks 1–6 complete; Task 7 partial (ops docs aligned 2026-08-16). Capability: **Build-verified / Pilot** per [`capability-status.md`](../../roadmap/capability-status.md). Default cutover remains disabled.
...
- [x] **Step 1: 写 Worker composition RED 测试**
