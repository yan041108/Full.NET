...
- [x] **Step 3: Implement parameterized metadata reads**
...
- [x] **Step 4: Verify importer GREEN**

运行 Task 2 Step 2 命令并要求全部通过。

- [x] **Step 5: Add real dual-provider integration RED/GREEN**
