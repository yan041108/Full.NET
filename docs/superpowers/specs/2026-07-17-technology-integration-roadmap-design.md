...
| MassTransit + RabbitMQ | 真实跨进程消息出现后引入 | M4+ EventBus Provider |
...
4. M4 MassTransit/RabbitMQ EventBus Provider；
5. M4 YARP Gateway Provider；
6. M5+ Elsa Workflow Module；
7. M5+ Envoy/Linkerd Kubernetes 部署模板。
