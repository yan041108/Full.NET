...
4. API rejection is HTTP 503 with code `common.database.capacity_exhausted`; Worker stops new acquisition and backs off. Do not convert this signal into unbounded retries.
