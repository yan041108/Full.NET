...
/// </summary>
internal sealed record ModuleIntegrationProjectedSourceFile(
    string FullPath,
    string Content);
...
/// </summary>
internal sealed class ModuleIntegrationBuildProjection
{
    ...
    private static string GenerateProbe(FullNetCrudSchema schema) =>
        Normalize(
            ...
            internal static class {{schema.ClrTypeName}}IntegrationCompileProbe
            {
