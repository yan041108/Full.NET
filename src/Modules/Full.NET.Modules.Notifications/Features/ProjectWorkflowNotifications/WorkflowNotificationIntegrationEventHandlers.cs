...
/// <summary>把工作流实例完成事实投影为通知意图。</summary>
internal sealed class WorkflowInstanceCompletedNotificationSink(
    WorkflowNotificationProjectionService projection) : IWorkflowInstanceCompletedSink
{
    /// <inheritdoc />
    public Task HandleAsync(
        IntegrationEventContext context,
...
/// <summary>把工作流实例驳回事实投影为通知意图。</summary>
internal sealed class WorkflowInstanceRejectedNotificationSink(
    WorkflowNotificationProjectionService projection) : IWorkflowInstanceRejectedSink
{
    /// <inheritdoc />
    public Task HandleAsync(
        IntegrationEventContext context,
...
/// <summary>把工作流实例取消事实投影为通知意图。</summary>
internal sealed class WorkflowInstanceCancelledNotificationSink(
    WorkflowNotificationProjectionService projection) : IWorkflowInstanceCancelledSink
{
    /// <inheritdoc />
    public Task HandleAsync(
        IntegrationEventContext context,
