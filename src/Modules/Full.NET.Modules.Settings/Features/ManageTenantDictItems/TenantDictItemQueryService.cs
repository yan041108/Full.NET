...
/// <summary>租户数据字典项分页列表与详情只读查询。</summary>
internal sealed class TenantDictItemQueryService(
    ...
    IOptions<DatabaseOptions> databaseOptions)
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            DatabaseProvider.SqlServer => TenantDictItemSql.ListByTypeIdSqlServer,
            DatabaseProvider.MySql => TenantDictItemSql.ListByTypeIdMySql,
