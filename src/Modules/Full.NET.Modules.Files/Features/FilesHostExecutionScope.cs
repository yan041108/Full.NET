...
namespace Full.NET.Modules.Files.Features;

/// <summary>在单次请求内临时切换到 Host 上下文，执行 HostOnly 配额 SQL 后恢复租户上下文。</summary>
internal static class FilesHostExecutionScope
{
