...
CREATE TABLE IF NOT EXISTS fn_workflow_instance (
    ...
    ActiveBusinessKey varchar(258) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin GENERATED ALWAYS AS (CASE WHEN StatusKey = 'active' THEN CONCAT(TenantScopeKey, '|', BusinessType, '|', BusinessId) ELSE NULL END) STORED COMMENT '占用中的实例业务唯一键',
