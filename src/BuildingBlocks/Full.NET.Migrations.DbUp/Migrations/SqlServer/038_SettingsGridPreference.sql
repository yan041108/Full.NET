...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'系统设置用户表格偏好表', @level0type=N'SCHEMA', @level0name=N'dbo', @level1type=N'TABLE', @level1name=N'fn_settings_user_grid_preference';
    IF NOT EXISTS (
        SELECT 1
        FROM sys.extended_properties
        WHERE class = 1
