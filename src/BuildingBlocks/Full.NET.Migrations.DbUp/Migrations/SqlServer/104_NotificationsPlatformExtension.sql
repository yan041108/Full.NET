...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'通知通知意图表', @level0type=N'SCHEMA', @level0name=N'dbo', @level1type=N'TABLE', @level1name=N'fn_notifications_intent';
    IF NOT EXISTS (
        SELECT 1
        FROM sys.extended_properties
        WHERE class = 1
    ...
    IF NOT EXISTS (
        ...
        EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'状态键', @level0type=N'SCHEMA', @level0name=N'dbo', @level1type=N'TABLE', @level1name=N'fn_notifications_intent', @level2type=N'COLUMN', @level2name=N'StatusKey';
    IF NOT EXISTS (
        SELECT 1
        FROM sys.extended_properties
        WHERE class = 1
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'通知通知偏好表', @level0type=N'SCHEMA', @level0name=N'dbo', @level1type=N'TABLE', @level1name=N'fn_notifications_preference';
    IF NOT EXISTS (
        SELECT 1
        FROM sys.extended_properties
        WHERE class = 1
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'状态键', @level0type=N'SCHEMA', @level0name=N'dbo', @level1type=N'TABLE', @level1name=N'fn_notifications_delivery', @level2type=N'COLUMN', @level2name=N'StatusKey';
    IF NOT EXISTS (
        SELECT 1
        FROM sys.extended_properties
        WHERE class = 1
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'状态键', @level0type=N'SCHEMA', @level0name=N'dbo', @level1type=N'TABLE', @level1name=N'fn_notifications_delivery_attempt', @level2type=N'COLUMN', @level2name=N'StatusKey';
    IF NOT EXISTS (
        SELECT 1
        FROM sys.extended_properties
        WHERE class = 1
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Detail(JSON)', @level0type=N'SCHEMA', @level0name=N'dbo', @level1type=N'TABLE', @level1name=N'fn_notifications_domain_audit', @level2type=N'COLUMN', @level2name=N'DetailJson';
    IF NOT EXISTS (
        SELECT 1
        FROM sys.extended_properties
        WHERE class = 1
    ...
    IF NOT EXISTS (
        ...
        EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'结果键', @level0type=N'SCHEMA', @level0name=N'dbo', @level1type=N'TABLE', @level1name=N'fn_notifications_domain_audit', @level2type=N'COLUMN', @level2name=N'OutcomeKey';
    IF NOT EXISTS (
        SELECT 1
        FROM sys.extended_properties
        WHERE class = 1
