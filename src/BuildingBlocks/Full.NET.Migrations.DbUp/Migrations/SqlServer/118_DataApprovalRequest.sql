...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'数据审批申请表', @level0type=N'SCHEMA', @level0name=N'dbo', @level1type=N'TABLE', @level1name=N'fn_dataapproval_request';
    IF NOT EXISTS (
        SELECT 1
        FROM sys.extended_properties
        WHERE class = 1
    ...
    IF NOT EXISTS (
        ...
        EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'场景键', @level0type=N'SCHEMA', @level0name=N'dbo', @level1type=N'TABLE', @level1name=N'fn_dataapproval_request', @level2type=N'COLUMN', @level2name=N'ScenarioKey';
    IF NOT EXISTS (
        SELECT 1
        FROM sys.extended_properties
        WHERE class = 1
    ...
    IF NOT EXISTS (
        ...
        EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'提交人用户标识', @level0type=N'SCHEMA', @level0name=N'dbo', @level1type=N'TABLE', @level1name=N'fn_dataapproval_request', @level2type=N'COLUMN', @level2name=N'SubmittedByUserId';
    IF NOT EXISTS (
        SELECT 1
        FROM sys.extended_properties
        WHERE class = 1
        ...
        EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'目标实体标识', @level0type=N'SCHEMA', @level0name=N'dbo', @level1type=N'TABLE', @level1name=N'fn_dataapproval_request', @level2type=N'COLUMN', @level2name=N'TargetEntityId';
    IF NOT EXISTS (
        SELECT 1
        FROM sys.extended_properties
        WHERE class = 1
    ...
    IF NOT EXISTS (
        ...
        EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'工作流定义版本标识', @level0type=N'SCHEMA', @level0name=N'dbo', @level1type=N'TABLE', @level1name=N'fn_dataapproval_request', @level2type=N'COLUMN', @level2name=N'WorkflowDefinitionVersionId';
    IF NOT EXISTS (
        SELECT 1
        FROM sys.extended_properties
        WHERE class = 1
        ...
        EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'工作流实例标识', @level0type=N'SCHEMA', @level0name=N'dbo', @level1type=N'TABLE', @level1name=N'fn_dataapproval_request', @level2type=N'COLUMN', @level2name=N'WorkflowInstanceId';
    IF NOT EXISTS (
        SELECT 1
        FROM sys.extended_properties
        WHERE class = 1
        ...
        EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'工作流修订号', @level0type=N'SCHEMA', @level0name=N'dbo', @level1type=N'TABLE', @level1name=N'fn_dataapproval_request', @level2type=N'COLUMN', @level2name=N'WorkflowRevision';
    IF NOT EXISTS (
        SELECT 1
        FROM sys.extended_properties
        WHERE class = 1
