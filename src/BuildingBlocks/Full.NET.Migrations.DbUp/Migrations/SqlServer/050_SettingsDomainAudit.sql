...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        WHERE class = 1
          AND major_id = OBJECT_ID(N'dbo.fn_settings_domain_audit')
          AND minor_id = 0
    ...
    IF NOT EXISTS (
        ...
        WHERE class = 1
          AND major_id = OBJECT_ID(N'dbo.fn_settings_domain_audit')
          AND minor_id = COLUMNPROPERTY(OBJECT_ID(N'dbo.fn_settings_domain_audit'), N'ActionKey', 'ColumnId')
          AND name = N'MS_Description'
    )
    ...
    IF NOT EXISTS (
        ...
        WHERE class = 1
          AND major_id = OBJECT_ID(N'dbo.fn_settings_domain_audit')
          AND minor_id = COLUMNPROPERTY(OBJECT_ID(N'dbo.fn_settings_domain_audit'), N'ActorDisplayName', 'ColumnId')
          AND name = N'MS_Description'
    )
    ...
    IF NOT EXISTS (
        ...
        WHERE class = 1
          AND major_id = OBJECT_ID(N'dbo.fn_settings_domain_audit')
          AND minor_id = COLUMNPROPERTY(OBJECT_ID(N'dbo.fn_settings_domain_audit'), N'ActorUserId', 'ColumnId')
          AND name = N'MS_Description'
    )
    ...
    IF NOT EXISTS (
        ...
        WHERE class = 1
          AND major_id = OBJECT_ID(N'dbo.fn_settings_domain_audit')
          AND minor_id = COLUMNPROPERTY(OBJECT_ID(N'dbo.fn_settings_domain_audit'), N'DiffSummaryJson', 'ColumnId')
          AND name = N'MS_Description'
    )
    ...
    IF NOT EXISTS (
        ...
        WHERE class = 1
          AND major_id = OBJECT_ID(N'dbo.fn_settings_domain_audit')
          AND minor_id = COLUMNPROPERTY(OBJECT_ID(N'dbo.fn_settings_domain_audit'), N'EntityId', 'ColumnId')
          AND name = N'MS_Description'
    )
    ...
    IF NOT EXISTS (
        ...
        WHERE class = 1
          AND major_id = OBJECT_ID(N'dbo.fn_settings_domain_audit')
          AND minor_id = COLUMNPROPERTY(OBJECT_ID(N'dbo.fn_settings_domain_audit'), N'Id', 'ColumnId')
          AND name = N'MS_Description'
    )
    ...
    IF NOT EXISTS (
        ...
        WHERE class = 1
          AND major_id = OBJECT_ID(N'dbo.fn_settings_domain_audit')
          AND minor_id = COLUMNPROPERTY(OBJECT_ID(N'dbo.fn_settings_domain_audit'), N'OccurredAtUtc', 'ColumnId')
          AND name = N'MS_Description'
    )
    ...
    IF NOT EXISTS (
        ...
        WHERE class = 1
          AND major_id = OBJECT_ID(N'dbo.fn_settings_domain_audit')
          AND minor_id = COLUMNPROPERTY(OBJECT_ID(N'dbo.fn_settings_domain_audit'), N'Outcome', 'ColumnId')
          AND name = N'MS_Description'
    )
    ...
    IF NOT EXISTS (
        ...
        WHERE class = 1
          AND major_id = OBJECT_ID(N'dbo.fn_settings_domain_audit')
          AND minor_id = COLUMNPROPERTY(OBJECT_ID(N'dbo.fn_settings_domain_audit'), N'TenantId', 'ColumnId')
          AND name = N'MS_Description'
    )
    ...
    IF NOT EXISTS (
        ...
        WHERE class = 1
          AND major_id = OBJECT_ID(N'dbo.fn_settings_domain_audit')
          AND minor_id = COLUMNPROPERTY(OBJECT_ID(N'dbo.fn_settings_domain_audit'), N'TraceId', 'ColumnId')
          AND name = N'MS_Description'
    )
