...
async function load(): Promise<void> {
  ...
  try {
    const page = await listSettingsDictTypes();
...
async function loadItems(dictTypeId: string): Promise<void> {
  ...
  try {
    const page = await listSettingsDictItems(dictTypeId);
    ...
    <el-card class="art-table-card" shadow="never">
      ...
      <article v-for="dictType in dictTypes" :key="dictType.id" class="art-data-row">
        ...
        <div class="art-data-row__actions">
          ...
          <PermissionGate v-if="dictType.isActive" code="settings.dict_types.disable">
          <el-button
            type="danger"
            plain
            :disabled="changing"
      ...
      <div data-dict-items-directory>
        <article v-for="item in dictItems" :key="item.id" class="art-data-row">
          ...
          <div class="art-data-row__actions">
            ...
            <PermissionGate v-if="item.isActive" code="settings.dict_types.disable">
            <el-button
              type="danger"
              plain
              :disabled="changing"
