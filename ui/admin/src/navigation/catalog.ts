...
const messageKeys = new Map<string, Pick<LocalNavigationDefinition, 'titleKey' | 'captionKey'>>([
  ...
  ['oidc-clients', {
    titleKey: 'navigation.oidcClients.title',
    captionKey: 'navigation.oidcClients.caption'
  }],
  ['oidc-authorizations', {
  ...
  ['module-selection', {
    titleKey: 'navigation.moduleSelection.title',
    captionKey: 'navigation.moduleSelection.caption'
  }],
  ['roles', {
  ...
  ['document-preview-tasks', {
    titleKey: 'navigation.documentPreviewTasks.title',
    captionKey: 'navigation.documentPreviewTasks.caption'
  }],
  ['import-export-tasks', {
    titleKey: 'navigation.importExportTasks.title',
    captionKey: 'navigation.importExportTasks.caption'
  }],
  ['reporting-data-sources', {
    titleKey: 'navigation.reportingDataSources.title',
    captionKey: 'navigation.reportingDataSources.caption'
  }],
  ['reporting-definitions', {
    titleKey: 'navigation.reportingDefinitions.title',
    captionKey: 'navigation.reportingDefinitions.caption'
  }],
  ['reporting-execute', {
  ...
  ['personal-schedules', {
    titleKey: 'navigation.personalSchedules.title',
    captionKey: 'navigation.personalSchedules.caption'
  }],
  ['host-release-notes', {
  ...
  ['code-generation-catalog', {
    titleKey: 'navigation.codeGenerationCatalog.title',
    captionKey: 'navigation.codeGenerationCatalog.caption'
  }],
  ...
  ['ai-agent-runs', {
    titleKey: 'navigation.aiAgentRuns.title',
    captionKey: 'navigation.aiAgentRuns.caption'
  }]
]);
